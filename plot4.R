...
with(house_data, plot(datetime, Voltage, type = "l")
)
with(house_data,{
plot(datetime, Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering")
points(datetime, Sub_metering_2, type = "l", col = "red")
points(datetime, Sub_metering_3, type = "l", col = "blue")
legend("topright", pch = c(NA, NA, NA), lty = c(1, 1, 1), col=c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), xjust = 1, bty = "n")
})
with(house_data, plot(datetime, Global_reactive_power, type = "l", xlab = "datetime"))
